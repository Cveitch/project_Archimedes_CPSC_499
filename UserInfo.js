...
{
    //This method should always be called sometime after the increaseLevelAttempts()
    //since there will always be at least one attempt so there shouldn't be any need
    //to check that the value isn't null.
